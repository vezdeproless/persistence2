...
param(
    ...
    [string]$RemotePath = "/home/analyst/uploads",
    ...
    if (Test-Path -LiteralPath $usersRoot -PathType Container) {
        ...
        Get-ChildItem -LiteralPath $usersRoot -Directory -Force | Where-Object {
            ...
            $ntuserFiles = @(
                ...
                @{ Source = "NTUSER.DAT.LOG1"; Destination = "$safeUser.DAT.LOG1" },
                @{ Source = "NTUSER.DAT.LOG2"; Destination = "$safeUser.DAT.LOG2" }
            )
            ...
            $usrClassFiles = @(
                ...
                @{ Source = "UsrClass.dat.LOG1"; Destination = "$safeUser.DAT.LOG1" },
                @{ Source = "UsrClass.dat.LOG2"; Destination = "$safeUser.DAT.LOG2" }
            )
